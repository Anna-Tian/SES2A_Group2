...
! function() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		var e = this,
			...
			n = {
				cn: {
					weeks: ["Sun", "Mon", "Tus", "Wed", "Thu", "Fir", "Sat"],
					time: ["hour", "min", "sec"],
					timeTips: "Choose date",
		...
		return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = w.extend({}, i.startDate), w.each([i.startDate, i.endDate], function(e, t) {
			m(t, l[e], e)
		})) : m(o, l) : (i.hint("Invaild date<br>Please follow this format：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>Already reset"), a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse()), e && e(), i)
		...
		if (l.year < d[0] && (l.year = d[0], r.hint("You can only choose from" + d[0] + "Year")), l.year > d[1] && (l.year = d[1], r.hint("You can only choose up to" + d[1] + "Year")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month || 12, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function(e, n) {
			...
			], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("Time", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [
				[l.year, l.month + 1]
		...
		var n = this,
			...
			o = {
				...
				confirm: function() {
					if (a.range) {
						if (!n.endDate) return n.hint("Please choose date");
						if (w(e).hasClass(s)) return n.hint("time" === a.type ? l.replace(/date/g, "hour") : l)
					} else if (w(e).hasClass(s)) return n.hint("Invaild date");
